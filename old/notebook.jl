...
# ╔═╡ 12b01c00-e7bd-11ed-2957-759df3ef9e20
begin
	using Plots
...
# ╔═╡ 9bf70374-450f-4d14-8361-de267c845e64
...
# ╔═╡ 1e5cabe9-168b-4943-a5ee-3a2fb9e162cf
begin
	mu = 3.986004418E+05; # Earth's gravitational parameter [km^3/s^2]
	
	# Initial Condition
	u0 = [-2500.0; -5500.0; 3400.0; 7.5; 0.0; 4.0]; # [km, km/s]
	tspan = (0.0, 10000.0);
	
	prob = ODEProblem(ode_2bp!, u0, tspan, mu);
	
	sol = solve(prob, AutoTsit5(Rosenbrock23()), reltol = 1e-12, abstol = 1e-14);
end

# ╔═╡ 20a6a854-3e29-4694-92f9-1caeb173e781
plot(sol, 
	idxs = (1, 2, 3), 
...
# ╔═╡ 58f6fb91-4cb3-4fcb-9034-78c6efca51f3
length(sol)

# ╔═╡ 755d1de6-fe0c-4d0c-8950-af263ee9458f
...
# ╔═╡ 00dc1578-efa0-4079-8acf-d93ddc52bc60
struct KeplerElem
	a::Number
	e::Number
	i::Number
...
# ╔═╡ df15fcc6-23ad-471f-babf-5dee5894c9b1
struct StateVec
	pos::Vector{<:Number}
	vel::Vector{<:Number}
	vec::Vector{<:Number}
...
# ╔═╡ 48f1cf79-4ca1-4e09-b5cc-b1c0fbdb0534
begin
...
# ╔═╡ 4b438abc-2d41-45ab-80b9-1bddd8323743
begin
...
# ╔═╡ ec6f2c65-1464-436c-a1cb-9925e82a0ab8
begin
...
# ╔═╡ 338a8897-d300-480b-a82c-b5f1eaf4153b
begin
	kepler_to_rv(kepkep, mu)
	rv_to_kepler(statevec, mu)
end

# ╔═╡ 1092363b-bbed-4146-b09b-0f4ff150e62c
ke = KeplerElem(a, e, i, Ω, ω, f)

# ╔═╡ 28f6affb-3e31-4c86-a13e-3a425ecc47e8
sv = StateVec(r_ijk, v_ijk/1.1)

# ╔═╡ 9ad38869-b973-48c0-8d8f-b84bc805aac8
struct Body
	name::String
	class::String
	radius::Number
...
# ╔═╡ 45447813-9adf-407f-806d-ecea9168cc8d
begin
	# Stars
...
# ╔═╡ 76a32c73-ed84-432c-a52a-920504c24a6b
Earth

# ╔═╡ 44b77812-3f3b-497b-bcd4-387aaab777ad
struct Node
	name::String
	θ::Number
...
# ╔═╡ bfddf1da-28ee-452f-99d9-4aea3f322cfd
...
# ╔═╡ 092c266d-5381-47be-816d-a27a9bcce414
function add_node(orb::Orbit, node::Node) 
	orb.nodes = [orb.nodes; node];
	return orb
end

# ╔═╡ 9ed73fb8-3770-4f96-a25a-6a1070ac86ec
o1 = Orbit("Alfa", ke, Earth)

# ╔═╡ d3105ca9-09be-423c-b56f-368e0300f5ce
n1 = Node("n1", 1.35)

# ╔═╡ 85bd508f-16de-4f98-be9a-4999b4acf0ba
o11 = add_node(o1, n1)

# ╔═╡ c05189b3-0122-4cac-b9a4-cf4932e0215b
begin
	o22 = o1
	o22 = add_node(o22, n1)
end

# ╔═╡ 7db10e01-03c1-40c6-b617-f327fe9d326f
o22

# ╔═╡ 8b96ba4f-1090-475c-bc64-80a15f39935c
o2 = Orbit("Beta", sv, Earth)

# ╔═╡ 9df0d842-80c5-4c03-9df8-c0d6587800e5
o1.nodes

# ╔═╡ db0a6978-0986-44b3-b49c-c895b94cd549
begin
...
# ╔═╡ 3a275aa4-6dcf-4cad-b1b5-0c5b4d5bb518
begin
	plot_orbit(o2, (3, :dash, :cyan))
	plot_orbit!(o1, (1, :solid, :magenta))
end

# ╔═╡ ff391813-7540-41ed-bd1b-bdb26c7a1b0c
begin
...
# ╔═╡ b8cb5244-613b-4ef4-80c0-65bcc22b9042
begin
	plot_body(Earth)
	plot_body!(Mars)
end

# ╔═╡ 8a4c2b01-0d37-452f-9bca-c39b6bdcfb79
begin
...
# ╔═╡ d46aaa91-1b78-4ccd-bc8c-a21672bf454e
begin
	plotOrbit(o1)
	plotOrbit!(o2)
end

# ╔═╡ d40f92ed-12e1-482b-ae5e-e9990fd68464
begin
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "dd2125c94d19687174e3a5e625ce783901f60c8f"
